import svgPaths from "./svg-4bc3oyeqta";
...
function TitleBar() {
  return (
    <div className="content-stretch flex gap-[229px] h-[48px] items-center px-[16px] relative shrink-0 w-[360px]" style={{ backgroundImage: "linear-gradient(105.26deg, rgb(79, 161, 249) 6.717%, rgb(112, 83, 245) 109.71%)" }} data-name="title bar">
      <Component />
      <div className="h-[17px] relative shrink-0 w-[20px]" data-name="Union">
    ...
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">출제연도 선택</p>
...
function Familysite1() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">학교명 입력</p>
        </div>
      </div>
    </div>
  );
...
function Familysite2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">학교명 입력 시 자동입력</p>
        </div>
      </div>
    </div>
  );
...
function Familysite3() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">학년 선택</p>
          <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 size-[20px]" data-name="icon slot">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="arrow-down-simple">
              <div className="absolute bottom-[31.67%] flex items-center justify-center left-1/4 right-1/4 top-[37.5%]" style={{ containerType: "size" }}>
                <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
...
function Familysite4() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">학기 선택</p>
          <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 size-[20px]" data-name="icon slot">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="arrow-down-simple">
              <div className="absolute bottom-[31.67%] flex items-center justify-center left-1/4 right-1/4 top-[37.5%]" style={{ containerType: "size" }}>
                <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
...
function Familysite6() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">학년·학기 선택</p>
          <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 size-[20px]" data-name="icon slot">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="arrow-down-simple">
              <div className="absolute bottom-[31.67%] flex items-center justify-center left-1/4 right-1/4 top-[37.5%]" style={{ containerType: "size" }}>
                <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
...
function InputLegacy() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start py-[16px] relative shrink-0 w-full" data-name="input-legacy">
      <div className="content-start flex flex-wrap font-bold gap-[2px] items-start leading-[1.44] not-italic relative shrink-0 text-[#8c98a1] text-[13px] tracking-[0.32px] w-full whitespace-nowrap" data-name="Dropdown Title">
        <p className="font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] relative shrink-0">학년·학기</p>
        <p className="font-['Inter:Bold',sans-serif] relative shrink-0">*</p>
      </div>
      <div className="bg-white h-[55px] relative rounded-[4px] shrink-0 w-full" data-name="dropbox">
...
function Familysite7() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">수학</p>
          <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 size-[20px]" data-name="icon slot">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="arrow-down-simple">
              <div className="absolute bottom-[31.67%] flex items-center justify-center left-1/4 right-1/4 top-[37.5%]" style={{ containerType: "size" }}>
                <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
...
function InputLegacy1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start py-[16px] relative shrink-0 w-full" data-name="input-legacy">
      <div className="content-start flex flex-wrap font-bold gap-[2px] items-start leading-[1.44] not-italic relative shrink-0 text-[#8c98a1] text-[13px] tracking-[0.32px] w-full whitespace-nowrap" data-name="Dropdown Title">
        <p className="font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] relative shrink-0">과목</p>
        <p className="font-['Inter:Bold',sans-serif] relative shrink-0">*</p>
      </div>
      <div className="bg-[#f1f4f8] h-[55px] relative rounded-[4px] shrink-0 w-full" data-name="dropbox">
        <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
...
function Familysite8() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="familysite">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center pl-[20px] pr-[16px] py-[16px] relative size-full">
          <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[1.44] min-w-px not-italic relative text-[#8c98a1] text-[16px] tracking-[0.32px]">공통</p>
          <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 size-[20px]" data-name="icon slot">
            <div className="flex-[1_0_0] min-h-px relative w-full" data-name="arrow-down-simple">
              <div className="absolute bottom-[31.67%] flex items-center justify-center left-1/4 right-1/4 top-[37.5%]" style={{ containerType: "size" }}>
                <div className="-rotate-90 flex-none h-[100cqw] w-[100cqh]">
...
function InputLegacy2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start py-[16px] relative shrink-0 w-full" data-name="input-legacy">
      <div className="content-start flex flex-wrap font-bold gap-[2px] items-start leading-[1.44] not-italic relative shrink-0 text-[#8c98a1] text-[13px] tracking-[0.32px] w-full whitespace-nowrap" data-name="Dropdown Title">
        <p className="font-['Inter:Bold','Noto_Sans_KR:Bold',sans-serif] relative shrink-0">출판사</p>
        <p className="font-['Inter:Bold',sans-serif] relative shrink-0">*</p>
      </div>
      <div className="bg-[#f1f4f8] h-[55px] relative rounded-[4px] shrink-0 w-full" data-name="dropbox">
        <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
...
function FileItemContainer() {
  return <div className="content-stretch flex h-[60px] items-center py-[8px] relative rounded-[10px] shrink-0 w-full" data-name="File Item Container" />;
}
    ...
    <div className="relative shrink-0 w-full" data-name="버튼">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[8px] items-center justify-center p-[24px] relative size-full">
          <div className="bg-white max-w-[400px] relative rounded-[999px] shrink-0" data-name="button-legacy">
          ...
          <div className="bg-[rgba(140,152,161,0.24)] flex-[1_0_0] max-w-[400px] min-w-px relative rounded-[999px]" data-name="button-legacy">
...
export default function S6Form() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="s6-form">
      <TitleBar />
      <Frame3 />
      <Body />
      <Component7 />
